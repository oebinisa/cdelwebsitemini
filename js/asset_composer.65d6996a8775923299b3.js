!(function(e) {
      ...
      (t.ErrorReporter = (function() {
        function e(t) {
          ...
          i(this, e),
            (this.win = t),
            (this.useConsole = n),
            (this.errorReportingEnabled = this.getErrorReportingEnabled()),
            (this.rollbarClientLoadedInternally = !1),
            (this.errorLoadingRollbar = !1),
            (this.rollbarInstance = null),
        ...
        return (
          r(e, [
            ...
            },
            {
              ...
              value: function() {
                var e = this;
                (this.rollbarInstance = new this.win.rollbar(u)),
                  (this.rollbarClientLoadedInternally = !0),
                  this.reportCallQueue.forEach(function(t) {
              ...
              value: function(e, t, n) {
                ...
                if (!this.errorLoadingRollbar && this.errorReportingEnabled) {
                  var i = Boolean(this.win.rollbar),
                    u = { msg: e, error: t, extraData: n };
                  if (this.rollbarClientLoadedInternally)
                    this.rollbarInstance.error(e, t, n);
                  else if (i)
                    try {
                    ...
                    this.reportCallQueue.length > 0
                      ? this.reportCallQueue.push(u)
                      : (this.reportCallQueue.push(u),
                        (0, o.loadScript)(
                          "https://cdnjs.cloudflare.com/ajax/libs/rollbar.js/2.4.1/rollbar.noconflict.umd.min.js",
                          function(e) {
            ...
            },
            {
              ...
              value: function() {
                return (
                  !this.win.zESettings ||
                  void 0 === this.win.zESettings.errorReporting ||
                  Boolean(this.win.zESettings.errorReporting)
                );
              },
            },
          ]),
  ...
  function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.Snippet = void 0);
    var r = (function() {
        function e(e, t) {
          for (var n = 0; n < t.length; n++) {
            var r = t[n];
        ...
        r(e, [
          {
            ...
            value: function() {
              ...
              return new o.default(function(t, n) {
                ...
                "loading" !== r.readyState && r.body
                  ? t()
                  : r.addEventListener("DOMContentLoaded", function() {
                      r.body
                        ? t()
                        : n(
                            new i.AssetComposerError(
                              "host page document.body not available"
                            )
                          );
                    });
              });
        ...
        r(t, [
          {
            ...
            value: function() {
              ...
              return new o.default(function(t, n) {
                return t(
                  "zopim_chat/" +
                    (0, u.getQueryParamsString)(e.win.$zopim.s.src)
                );
              });
            },
          },
        ...
        r(
          ...
          [
            ...
            },
            {
              key: "_getScript",
              value: function(e) {
                var n = t.isDynamicSnippetPresent(this.win);
            ...
            value: function() {
              ...
              return new i.default(function(t, n) {
                ...
                return r
                  ? e._isHostMapped(r)
                    ? (0, o.default)(
                        "https://" + r + "/embeddable/zendesk_host"
                      )
                        .then(function(e) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.setUpSnippet = function(e) {
        return o.WebWidgetNewSnippet.isDynamicSnippetPresent(e)
          ? new o.WebWidgetNewSnippet(e)
          : e.document.zendeskHost && e.document.zEQueue
          ? new r.WebWidgetOldSnippet(e)
          : e.$zopim
          ? new i.ZopimChatSnippet(e)
          : new o.WebWidgetNewSnippet(e);
      });
    var r = n(10),
      o = n(9),
        ...
        r(e, [
          {
            ...
            value: function() {
              ...
              return o.default.resolve({ zopimSrc: e });
            },
          },
          {
            key: "load",
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function(e, t) {
              e &&
                ...
                })({}, this.name, { id: this.id, features: this.features })),
                (e.zEQueue = t));
            },
          },
          {
          ...
          },
          {
            ...
            value: function() {
              ...
              return new i.AssetComposerError(
    ...
    t.ProductLoader = (function() {
      function e(t, n) {
        !(function(e, t) {
          ...
          (this.product = t),
          (this.productIframe = new c.ProductIframe(this.product, n)),
          (this.composeUrl = decodeURI(t.url) + "&use_json=true");
      }
      return (
        r(e, [
          {
            ...
            value: function(e) {
              ...
              return new i.default(function(n, r) {
                e
                  ? n(a.PRODUCT_MOCK_RESPONSES[t.product.name].assets)
                  : (0, o.default)(t.composeUrl)
                      .then(function(e) {
                        var t = e.assets;
                        return n(t);
                      })
          ...
          },
          {
            ...
            value: function() {
              var e = this.product,
                t = { product: e.name, id: e.id, features: e.features };
              return new u.AssetComposerError(
                "compose product request failed",
                t,
                !1
              );
            },
        ...
        r(e, [
            ...
            value: function(e) {
              ...
              return new i.default(function(r, i) {
                ...
                n
                  ? ((u.zEACLoaded = !0),
                    u.$zopim
                      ? r(a.COMPOSE_MOCK_ZOPIM_RESPONSE.products)
                      : r(a.COMPOSE_MOCK_RESPONSE.products))
                  : (0, o.default)("https://ekr.zdassets.com/compose/" + e)
                      .then(function(e) {
                        var t = e.products;
                        (u.zEACLoaded = !0), r(t);
                      })
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return e.map(function(e) {
                return "zopim_chat" === e.name
                  ? new s.ZopimChatLoader(e.id, t)
                  : new c.ProductLoader(e, t);
              });
            },
          },
          {
...
/*
     FILE ARCHIVED ON 17:33:57 Apr 14, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:20:35 Apr 26, 2020.
...
playback timings (ms):
  ...
  LoadShardBlock: 162.072 (3)
  RedisCDXSource: 8.044
  captures_list: 252.641
  PetaboxLoader3.datanode: 112.539 (4)
  PetaboxLoader3.resolve: 58.31 (2)
  load_resource: 40.939
*/
